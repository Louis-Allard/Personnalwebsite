  ...
  <b-container fluid class="p-4 container">
    ...
    <ul class="experiences_list">
      <li class="item_list">
        ...
        <br />
        <span class="item_describe">{{ cv.describexp01 }}</span>
      </li>
        <li class="item_list">
        <span class="item_title">{{ cv.datexp02 }} {{ cv.titlexp02 }}</span>
        <br />
        <span class="item_describe">{{ cv.describexp02 }}</span>
      </li>   
      <li class="item_list">
      ...
      <li class="item_list">
        ...
        <br />
        <span class="item_describe">{{ cv.describexp04 }}</span>
      </li>
        <li class="item_list">
    ...
    <ul class="experiences_list">
      <li class="item_list">
        <span class="item_title">{{ cv.datetraining }} {{ cv.titletraining }}</span>
        <br />
        ...
        <b-col>
          <div class="logo">
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/html.png')" alt="html" title="HTML"></b-img>
                </div>
              </div>
            </div>
            ...
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/css.png')" alt="css" title="CSS"></b-img>
                </div>
              </div>
            </div>
            ...
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/js.png')" alt="js" title="JavaScript"></b-img>
                </div>
              </div>
            </div>
            ...
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/vuejs.png')" alt="VueJs" title="VueJS"></b-img>
                </div>
              </div>
            </div>
          </div>
        ...
        <b-col>
          <div class="logo">
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/mysql.png')" alt="mysql" title="MySql"></b-img>
                </div>
              </div>
            </div>
            ...
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/node.png')" alt="node" title="Node"></b-img>
                </div>
              </div>
            </div>
            ...
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/redux.png')" alt="Redux" title="Redux"></b-img>
                </div>
              </div>
            </div>
          </div>
        ...
        <b-col>
          <div class="logo">
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/linux.png')" alt="linux" title="Linux"></b-img>
                </div>
              </div>
            </div>
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/git.png')" alt="git" title="Git"></b-img>
                </div>
              </div>
            </div>
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/github.png')" alt="github" title="Github"></b-img>
                </div>
              </div>
            </div>    
            <div class="zoom">
              <div>
                <div>
                  <b-img left fluid :src="require('../assets/python.png')" alt="python" title="Python"></b-img>
                </div>
              </div>
            </div>                    
          </div>
    ...
    <ul class="experiences_list">
      <li class="item_list" v-for="(softskill,key) in softskills" :key="key">{{ softskill }}</li>
    </ul>
  </b-container>
</div>
</template>
